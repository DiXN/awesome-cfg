...
local config = {
  ...
  commands = {
    ...
    dispsecondary = 'xrandr --output HDMI-A-2 --mode 3840x2160 --output DisplayPort-1 --off',
    dispfull = 'xrandr --output DisplayPort-1 --mode 3440x1440 && xrandr --output HDMI-A-2 --mode 3840x2160 --right-of DisplayPort-1',
    dispidle = 'xrandr --output DisplayPort-1 --mode 3440x1440 && xrandr --output HDMI-A-2 --off',
